...
| **Werkelijke waarden voor integratie van Project Operations (msdyn\_actuals)** | Geen | Geen | n.v.t. | Ja | Geen |
| **Projectcontractregels (salesorderdetails)** | Geen | Geen | n.v.t. | Geen | Geen |
| **Integratie-entiteit voor projecttransactierelaties (msdyn\_transactionconnections)** | Geen | Geen | n.v.t. | Geen | n.v.t. |
| **Mijlpalen voor de contractregel van Project Operations-integratie (msdyn\_contractlinesscheduleofvalues)** | Geen | Geen | n.v.t. | Geen | n.v.t. |
...
| **Entiteit voor exporteren van projectkosten voor Project Operations-integratie (msdyn\_expenses)** | Ja | Geen | n.v.t. | Geen | n.v.t. |
| **Entiteit voor tijdramingen van Project Operations-integratie (msdyn\_resourceassignments)** | Ja | Geen | n.v.t. | Geen | n.v.t. |
