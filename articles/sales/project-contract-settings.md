---
title: Koptekstdetails voor projectgebaseerde contracten
description: Dit artikel biedt informatie over de velden en informatie over projectgebaseerde contracten in Project Operations.
author: rumant
ms.date: 10/20/2020
ms.topic: article
...
| Bedrijf dat eigenaar is | Tabblad **Overzicht** | De rechtspersoon die verantwoording aflegt over de kosten en opbrengsten die voortvloeien uit de projecten die aan dit projectcontract zijn gekoppeld. Wanneer een contract wordt gemaakt op basis van een prijsopgave, wordt dit veld gekopieerd uit het overeenkomstige veld in de prijsopgaverecord. | Het bedrijf dat eigenaar is, komt overeen met het concept van rechtspersoon in de module **Projectmanagement en financiële administratie** van Project Operations. Alle kosten en opbrengsten die voortvloeien uit dit project worden verantwoord in het grootboek van het bedrijf dat de eigenaar is. |
| Klant | Tabblad **Overzicht** | Een verwijzing naar het bedrijf of de accountrecord van de klant. Wanneer een contract wordt gemaakt op basis van een prijsopgave, wordt dit veld gekopieerd uit het overeenkomstige veld in de prijsopgaverecord. | De valuta in het projectcontract wordt standaard ingesteld op basis van de valuta van de klant. De valuta kan worden gewijzigd voordat het contract wordt opgeslagen. |
...
| Geregistreerde hoeveelheid | Detail van een projectgebaseerde regel | Tijd: de hoeveelheid tijd van de totale werkelijke tijdkosten voor een rol in het project dat is toegewezen aan deze contractregel. Onkosten: alle hoeveelheden voor deze onkostencategorie met werkelijke onkosten in het project dat is toegewezen aan deze contractregel. |
