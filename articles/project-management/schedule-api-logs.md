...
description: Dit artikel biedt informatie en voorbeelden waarmee u de logboeken voor projectplanning kunt gebruiken om fouten op te sporen die verband houden met de projectplanningsservice en de API's voor projectplanning.
author: ruhercul
ms.date: 11/30/2021
ms.topic: article
