...
description: In dit artikel worden de sjabloon en de onderliggende taken besproken die worden gebruikt om projecttaken rechtstreeks vanuit Microsoft Dynamics 365 Project Service Automation met Dynamics 365 Finance te synchroniseren.
author: Yowelle
ms.date: 07/20/2018
ms.topic: article
ms.prod: ''
...
In dit artikel worden de sjabloon en de onderliggende taken besproken die worden gebruikt om projecttaken rechtstreeks vanuit Dynamics 365 Project Service Automation met Dynamics 365 Finance te synchroniseren.
