...
description: In dit artikel wordt uitgelegd hoe u voorwaarden voor betalen bij betaling (PWP) kunt maken, zodat u gedeeltelijke leveranciersbetalingen kunt vrijgeven op basis van klantbetalingen.
author: RadhikaRS
ms.date: 03/30/2020
ms.topic: article
ms.prod: ''
