...
description: In dit artikel worden de sjablonen en de onderliggende taken beschreven die worden gebruikt om projectuurschattingen en projectonkostenschattingen rechtstreeks van Microsoft Dynamics 365 Project Service Automation naar Dynamics 365 Finance te synchroniseren.
author: Yowelle
ms.date: 07/20/2018
ms.topic: article
ms.prod: ''
...
In dit artikel worden de sjablonen en de onderliggende taken beschreven die worden gebruikt om projectuurschattingen en projectonkostenschattingen rechtstreeks van Dynamics 365 Project Service Automation naar Dynamics 365 Finance te synchroniseren.
