...
description: In dit artikel worden de sjablonen en de onderliggende taken besproken die worden gebruikt om werkelijke projectwaarden rechtstreeks van Microsoft Microsoft Dynamics 365 Project Service Automation met financiën en bedrijfsactiviteiten te synchroniseren.
author: Yowelle
ms.date: 07/20/2018
ms.topic: article
ms.prod: ''
...
In dit artikel worden de sjablonen en de onderliggende taken besproken die worden gebruikt om werkelijke projectwaarden rechtstreeks van Microsoft Dynamics 365 Project Service Automation met Dynamics 365 Finance te synchroniseren.
