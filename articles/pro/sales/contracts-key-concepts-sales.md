...
ms.locfileid: "4643032"
---
# <a name="project-contracts---key-concepts---lite"></a>Belangrijke concepten van projectcontracten - lite
...
Productprijslijsten worden gebruikt om standaardprijzen, geen kostentarieven, te bepalen voor productgebaseerde regels in een contract. Er is slechts één productprijslijst per contract.
...
Deals voor meerdere klanten hebben meer dan één klant die moet worden gefactureerd in een deal. Dit zijn enkele veel voorkomende voorbeelden:
...
## <a name="changes-from-the-dynamics-365-sales-contract"></a>Wijzigingen ten opzichte van het contract in Dynamics 365 Sales

Contracten in Project Operations zijn gebaseerd op de contracten in Dynamics 365 Sales. Er zijn echter enkele belangrijke afwijkingen en verschillen in functionaliteit waarvan u op de hoogte moet zijn:

- Project Operations-contracten hebben twee verschillende soorten regels, één voor projecten en één voor producten.
