---
title: Koptekstdetails voor projectprijsopgaven
description: Dit artikel bevat informatie over de informatie en instellingen die van toepassing en van invloed zijn op projectprijsopgaven. (Sales)
author: rumant
ms.date: 10/01/2020
ms.topic: article
