...
description: Dit artikel biedt informatie over de kwaliteitsupdates die beschikbaar zijn in de versie van Project Operations van februari 2021 voor scenario's op basis van resources/niet-voorradige artikelen.
author: sigitac
ms.date: 02/08/2021
ms.topic: article
ms.prod: ''
...
| **Implementatie en configuratie** | 2139346 | Het probleem opgelost met het importeren van niet-beheerde **Dynamics365ProjectOperationsDualWrite**-oplossing. |
...
| **Beheer van verkoopkansen** | 2139330 | Het wijzigen van de projectmanager voor een project mag het bedrijf dat de eigenaar is niet terugzetten naar de standaardwaarde. |
